...
import Combine // TODO: remove dependence on Combine!
import OrderedCollections
import SwiftUI


struct FailedResult<FieldIdentifier> { // TODO accessibility!
...
public class ValidationEngines<FieldIdentifier: Hashable>: ObservableObject {
    ...
    func register(engine: ValidationEngine, field: FieldIdentifier?, input: String) -> EmptyView {
        ...
        // TODO: registration.anyCancellable = registration.engine.objectWillChange.sink { [weak self] _ in
